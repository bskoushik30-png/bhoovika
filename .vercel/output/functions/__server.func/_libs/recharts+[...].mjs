	...
	return _createClass$10(Area, [
		{
			...
			value: function renderDots(needClip, clipDot, clipPathId) {
				...
				return /*#__PURE__*/ import_react.createElement(Layer, _extends$11({ className: "recharts-area-dots" }, dotsProps), dots);
			}
		},
		{
		...
		},
		{
			...
			value: function renderAreaStatically(points, baseLine, needClip, clipPathId) {
				...
				return /*#__PURE__*/ import_react.createElement(Layer, { clipPath: needClip ? "url(#clipPath-".concat(clipPathId, ")") : null }, /*#__PURE__*/ import_react.createElement(Curve, _extends$11({}, filterProps(others, true), {
					points,
					connectNulls,
					type,
					baseLine,
				...
				})), stroke !== "none" && /*#__PURE__*/ import_react.createElement(Curve, _extends$11({}, filterProps(this.props, false), {
					...
					fill: "none",
					points
				})), stroke !== "none" && isRange && /*#__PURE__*/ import_react.createElement(Curve, _extends$11({}, filterProps(this.props, false), {
					className: "recharts-area-curve",
					layout,
					type,
					connectNulls,
...
_defineProperty$13(Area, "renderDotItem", function(option, props) {
	...
	if (/*#__PURE__*/ import_react.isValidElement(option)) dotItem = /*#__PURE__*/ import_react.cloneElement(option, props);
		...
		dotItem = /*#__PURE__*/ import_react.createElement(Dot, _extends$11({}, rest, {
			key,
			className
		}));
	}
